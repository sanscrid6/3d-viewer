import { PerspectiveCamera, Quaternion, Raycaster, Spherical, Vector2, Vector3 } from "three";
...
export class MoveSytem extends BaseSystem{
    ...
    constructor(viewer: Viewer){
        ...
        this._eventSystem.addListener(EventType.GlobalPonterClick, this.moveTo.bind(this))
    }
