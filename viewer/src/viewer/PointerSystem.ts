...
export class PointerSystem extends BaseSystem {
    ...
    constructor(viewer: Viewer){
        ...
        this._eventSystem.addListener(EventType.GlobalPointerMove, this.pointerMoveHandler.bind(this))
    ...
    pointerMoveHandler(e: MouseEvent){
        ...
        worldNormal.copy(objects[0].face!.normal).applyMatrix3(normalMatrix).normalize()
